...
namespace hill_climb
{
	...
	void no_action(Random & rand, vector<bool> & solution, float & fitness, Evaluator& evaluator);

	void binary_tournament(Random & rand, vector<bool> & solution, float & fitness, Evaluator& evaluator);

	void once_each(Random & rand, vector<bool> & solution, float & fitness, Evaluator& evaluator);
